<template>
	<div class="relative">
		...
		<v-select-dropdown width=166 v-if="isActive">
			<dropdown-item-currency-select v-for="currency in currencies" :icon="currency.icon" :value="currency.value" :symbol="currency.symbol" @click="selectOption(currency)"/>
		</v-select-dropdown>
	</div>
</template>
...
import DropdownItemCurrencySelect from '../components/DropdownItemCurrencySelect.vue'
