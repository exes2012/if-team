<template>
  ...
  <div class="flex max-w-[930px] mt-12 flex-col">
    <div class="flex w-full items-center">
      <v-input class="w-[445px] mr-5" label="Full name"/>
      <v-datepicker label="Date of birth" class="w-[445px] ml-5">
      </v-datepicker>
    </div>
    <div class="flex w-full">
      <v-input class="w-[445px] mr-5" label="Phone"/>
      <v-input class="w-[445px] ml-5" label="Email"/>
    </div>
    <div class="flex w-full">
